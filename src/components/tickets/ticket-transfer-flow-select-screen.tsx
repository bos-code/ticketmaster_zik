            ...
            return (
              ...
              >
                <Pressable
                  ...
                  className="h-[72px] w-[72px] overflow-hidden rounded-[8px] border border-[#D7DCE4] bg-white"
                >
                  ...
                  <View className="flex-1 items-center justify-center bg-[#FEFDFD]">
                    {selected ? (
                      <View className="h-[24px] w-[24px] items-center justify-center rounded-full bg-[#1977F3]">
                        <Ionicons name="checkmark" size={15} color="#FFFFFF" />
                      </View>
                    ) : (
                      <View className="size-6 rounded-full border border-[#DBE0E6]" />
                    )}
                  </View>
                </Pressable>
              </Animated.View>
