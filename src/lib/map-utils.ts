...
const FALLBACK_STATIC_MAP_CENTER = {
  latitude: 40.7505,
  longitude: -73.9934,
};
...
export function buildStaticMapPreviewUrl(
  ...
  const resolvedLongitude =
    typeof longitude === 'number' ? longitude : FALLBACK_STATIC_MAP_CENTER.longitude;
  const resolvedLatitude =
    typeof latitude === 'number' ? latitude : FALLBACK_STATIC_MAP_CENTER.latitude;
